...
* **Recall Memory:** Searches your vault (under `QwertyMemory/` and `dev/AI-Knowledge-Base/`). Queries are automatically parsed into keyword components to perform AND-based matches.
* **Save Memory:** Appends new facts dynamically to markdown shards inside your Obsidian Vault under `QwertyMemory/<slug>.md`.
