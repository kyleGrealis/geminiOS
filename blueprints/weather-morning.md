...
Formulate a clean, structured morning weather report starting directly with the details:
- Do NOT begin with conversational greetings to a specific person (e.g. avoid "Hey Kyle!" or "Hey Alexa!"). A neutral greeting like "Good morning!" or "Good evening!" is fine, or start directly.
...
- Include:
  ...
  * Today's forecast (High and Low temperatures, expected conditions for the day)
  * A TL;DR summary for the day ahead (e.g. daily highlights, heat indices, rain chance).
